...
{
	unsigned int maxwritecnt = (amd_gen < CHIPSET_YANGTZE)? FIFO_SIZE_OLD:FIFO_SIZE_YANGTZE;
	...
	unsigned int maxreadcnt = (amd_gen < CHIPSET_YANGTZE)? FIFO_SIZE_OLD:FIFO_SIZE_YANGTZE;
