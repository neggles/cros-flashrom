...
static struct wp_range_descriptor mx25u12835e_tb0_ranges[] = {
	{ .m = { .sec = X, .tb = X }, 0, {0, 0} },	/* none */
	{ .m = { .sec = 0, .tb = X }, 0x1, {0xff0000,   1 * 64 * 1024} },	/* block 255 */
	{ .m = { .sec = 0, .tb = X }, 0x2, {0xfe0000,   2 * 64 * 1024} },	/* blocks 254-255 */
	{ .m = { .sec = 0, .tb = X }, 0x3, {0xfc0000,   4 * 64 * 1024} },	/* blocks 252-255 */
	{ .m = { .sec = 0, .tb = X }, 0x4, {0xf80000,   8 * 64 * 1024} },	/* blocks 248-255 */
	{ .m = { .sec = 0, .tb = X }, 0x5, {0xf00000,  16 * 64 * 1024} },	/* blocks 240-255 */
	{ .m = { .sec = 0, .tb = X }, 0x6, {0xe00000,  32 * 64 * 1024} },	/* blocks 224-255 */
	{ .m = { .sec = 0, .tb = X }, 0x7, {0xc00000,  64 * 64 * 1024} },	/* blocks 192-255 */
	{ .m = { .sec = 0, .tb = X }, 0x8, {0x800000,  128 * 64 * 1024} },	/* blocks 128-255 */
	{ .m = { .sec = 0, .tb = X }, 0x9, {0x000000,  256 * 64 * 1024} },	/* blocks all */
	{ .m = { .sec = 0, .tb = X }, 0xa, {0x000000,  256 * 64 * 1024} },	/* blocks all */
	{ .m = { .sec = 0, .tb = X }, 0xb, {0x000000,  256 * 64 * 1024} },	/* blocks all */
	{ .m = { .sec = 0, .tb = X }, 0xc, {0x000000,  256 * 64 * 1024} },	/* blocks all */
	{ .m = { .sec = 0, .tb = X }, 0xd, {0x000000,  256 * 64 * 1024} },	/* blocks all */
	{ .m = { .sec = 0, .tb = X }, 0xe, {0x000000,  256 * 64 * 1024} },	/* blocks all */
	{ .m = { .sec = 0, .tb = X }, 0xf, {0x000000,  256 * 64 * 1024} },	/* blocks all */
};

static struct wp_range_descriptor mx25u12835e_tb1_ranges[] = {
	{ .m = { .sec = 0, .tb = X }, 0x1, {0x000000,   1 * 64 * 1024} },	/* block 0 */
	{ .m = { .sec = 0, .tb = X }, 0x2, {0x000000,   2 * 64 * 1024} },	/* blocks 0-1 */
	{ .m = { .sec = 0, .tb = X }, 0x3, {0x000000,   4 * 64 * 1024} },	/* blocks 0-3 */
	{ .m = { .sec = 0, .tb = X }, 0x4, {0x000000,   8 * 64 * 1024} },	/* blocks 0-7 */
	{ .m = { .sec = 0, .tb = X }, 0x5, {0x000000,  16 * 64 * 1024} },	/* blocks 0-15 */
	{ .m = { .sec = 0, .tb = X }, 0x6, {0x000000,  32 * 64 * 1024} },	/* blocks 0-31 */
	{ .m = { .sec = 0, .tb = X }, 0x7, {0x000000,  64 * 64 * 1024} },	/* blocks 0-63 */
	{ .m = { .sec = 0, .tb = X }, 0x8, {0x000000,  128 * 64 * 1024} },	/* blocks 0-127 */
	{ .m = { .sec = 0, .tb = X }, 0x9, {0x000000,  256 * 64 * 1024} },	/* blocks all */
	{ .m = { .sec = 0, .tb = X }, 0xa, {0x000000,  256 * 64 * 1024} },	/* blocks all */
	{ .m = { .sec = 0, .tb = X }, 0xb, {0x000000,  256 * 64 * 1024} },	/* blocks all */
	{ .m = { .sec = 0, .tb = X }, 0xc, {0x000000,  256 * 64 * 1024} },	/* blocks all */
