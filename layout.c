...
int register_include_arg(struct layout_include_args **args, char *include)
{
...
int find_romentry(struct flashrom_layout *const l, char *name, char *file)
{
	if (l->num_entries == 0)
		return -1;
